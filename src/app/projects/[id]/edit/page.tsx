...
import { Save, X, Loader2, ArrowLeft, FileEdit } from "lucide-react";
import { getProject, updateProject } from "@/services/firestoreService";
...
export default function EditProjectPage() {
    ...
    // No local settings fetch needed
    ...
    if (loading) return (
        <div style={{ maxWidth: 680, margin: "0 auto", padding: "40px" }} className="animate-pulse">
            <div className="h-40 bg-[var(--bg-card)] rounded-2xl mb-4"></div>
            <div className="h-96 bg-[var(--bg-card)] rounded-2xl"></div>
        </div>
    );
        ...
        <div className="py-10">
            ...
            >
                ...
                <p className="text-[13px] mb-8" style={{ color: "var(--text-muted)" }}>
                    Update the details for this academic project.
                </p>
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                    ...
                    <div style={{ borderTop: "1px solid var(--border-color)", paddingTop: 24 }} className="flex flex-col gap-3">
            ...
            <ConfirmModal 
                ...
                message={`Are you sure you want to delete "${form.title}"? This action is permanent and cannot be undone.`}
